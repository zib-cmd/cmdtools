...
def test_Newton():
    ...
    diff_tensor[1,:,:] = 1/(6.) *(-2*tensor[(0),:,:]-3*tensor[1,:,:]+6*tensor[2,:,:]-tensor[3,:,:])
         
    diff_tensor[2,:,:] = 1/(6.) *(tensor[0,:,:]-6*tensor[1,:,:]+3*tensor[2,:,:]+2*tensor[3,:,:])
            
    diff_tensor[3,:,:] = 1/(6.) *(-2*tensor[0,:,:]+9*tensor[1,:,:]-18*tensor[2,:,:]+11*tensor[3,:,:])
